import StandardPage, { PageContent } from "@/components/features/standardPage/standardPage";
...
export default async function Page({ 
    ...
    const data = await fetch(`http://127.0.0.1:8000/api/standard-page-api/?pageUrl=${pageName}`, {
        next: {
            revalidate: 3600
        }
    });
